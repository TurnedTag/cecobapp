...
import 'package:teste/pages/criar_atividade_page.dart';
...
class _ListaAtividadesState extends State<ListaAtividades> {
  ...
  Future<void> _fetchActivities() async {
    List<dynamic>? activities =
        await _activityService.listActivities(district: _selectedDistrict);
    if (activities != null) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomHeader(title: 'Atividades'),
      body: Center(
        child: Column(
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const CriarAtividade()),
                      );
                    },
